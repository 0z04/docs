---'[trunk']''
Name:'" ''kite/anchor''
'#'##'Run:'title:'::GLOW7::'Introduction to GitHub Packages
...
redirect_from:''
  '- ::GLOW7::/articles/about-github-package-registry
...
versions:
  free-pro-team: '*'
  enterprise-server: '>=0.12.8'
  github-ae: '*'
---mainbranch
'Name:Rust/Slate'{% data reusables.package_registry.packages-ghes-release-stage %}
...
{% if currentVersion == "free-pro-team@latest" %}
You can a package in the {% data variables.product.product_name %} user interface or using the REST API. For more information, see the "[{% data variables.product.prodname_registry %} API](/rest/reference/packages)."
{% if %}
